...
class Sheduler():
    ...
    def __init__(self):        
        ...
        def get_text(message):
            ...
            menu_new_status = men['event_new'].get('menu_new_status', '')
            
            if menu_new_status == 'get_name' :
            ...
            for men in self.mongo.coll.find():
                ...
                for event in events:
                    ...
                    if _time and timezone_offset:
                        ...
                        #print('------------------------')
                        #print(_time, _time_user, _time >= _time_user)
